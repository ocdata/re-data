...
var allTracks = {
	 "Research & Education": {
		...
		label_de:'Science & Technology', 
		label_en:'Science & Technology',
		color:[0, 153, 146, 1.0]
    },
		"Media & Journalism": {
		id: 'media-and-journalism', 
		label_de:'Media & Journalism', 
...
// rpEU17
var allDays = {
    '07.09.2017': { 'id': eventId +'-day-1', 'label_de':'7. Sept',
                                             'label_en':'Sept 7',
                                             'date':'2017-09-07' },
    '08.09.2017': { 'id': eventId +'-day-2', 'label_de':'8. Sept',
                                             'label_en':'Sept 8',
                                             'date':'2017-09-08' },
    '11.09.2017': { 'id': eventId +'-day-3', 'label_de':'11. Sept',
                                             'label_en':'Sept 11',
                                             'date':'2017-09-11' },
    '12.09.2017': { 'id': eventId +'-day-4', 'label_de':'12. Sept',
                                             'label_en':'Sept 12',
																						 'date':'2017-09-12' },
		'13.09.2017': { 'id': eventId +'-day-5', 'label_de':'13. Sept',
    																			 	 'label_en':'Sept 13',
																					 	 'date':'2017-09-13' }
};
...
var locationNameOrderPreference = [
	...
	"re:connecting Europe", "Networking Area (Halle 8)", "Newthinking", "re:play", "Outside", "Lounge", "Boat", "Breakout Area"
];
...
exports.scrape = function (callback) {
	require('../lib/json_requester').get(
		{
			urls: {
				sessions: 'https://re-publica.de/rest/sessions.json?args[0]=20092', // rpTEN id: 6553 rp15: 3013 rp17: 12419 eu17 20092
				speakers: 'https://re-publica.de/rest/speakers.json?args[0]=20092' // rpTEN id: 6553 rp15: 3013 rp17: 12419 eu17 20092
			}
		},
		function (result) {
			var data = [];
...
//                     }
			...
			// YT playlist id eurp17 not yet set
...
// Give null for playlistId to just don't do anything
